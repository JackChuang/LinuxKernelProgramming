...
int main(void)
{
	...
	printf(" returns: %d (should be -4) (IGNORE THIS. IT'S AN UPDATE)\n", ret);
	...
	printf(" returns: %d (should be -5) (IGNORE THIS. IT'S AN UPDATE)\n", ret);
	//ret = kvlib_print();
	...
	ret = kvlib_set("key640", "val640");
	printf("Insert a key640/val640 after formatting:\n");
	printf(" returns: %d (should be 0)\n", ret);
